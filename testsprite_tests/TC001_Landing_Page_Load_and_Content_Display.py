...
async def run_test():
    ...
    try:
        ...
        # -> Verify that featured products section loads with at least one product displayed
        await page.mouse.wheel(0, 600)
        

        # -> Verify testimonials section is visible and contains customer quotes
        await page.mouse.wheel(0, 800)
        

        # -> Verify category showcase displays all main jewelry categories
        await page.mouse.wheel(0, 800)
        

        # -> Verify Instagram feed section loads images from the feed
        await page.mouse.wheel(0, 1000)
        

        # -> Verify page performance meets Fast Contentful Paint target
        await page.mouse.wheel(0, -1000)
